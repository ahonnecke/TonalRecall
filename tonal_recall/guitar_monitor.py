...
class GuitarMonitor:
    ...
    """
    def __init__(self, input_device=None, output_device=None, samplerate=44100, blocksize=1024, channels=1):
        ...
        print(f"Using input_device={self.input_device}, output_device={self.output_device}")
